...
\institute[shortinst]{Max Planck Institute for Informatics, Saarbr\"{u}cken, Germany} %\and %
...
\titlegraphic{
 ...
 \includegraphics[height=1cm]{logo_mpi_430}
 %\\\includegraphics[height=2.3cm]{logo_bari}
