...
%\put(60,-110){\includegraphics[width=0.65\textwidth]{kb}}
%\caption{abc}
%\end{picture}
...
}{\alt<2->{\begin{picture}(0.5,0.5)\put(43,-43){\includegraphics[width=0.75\textwidth]{kg_1_5}}\end{picture}}{\begin{picture}(0.5,0.5)\put(43,-42){\includegraphics[width=0.75\textwidth]{kg_1}}\end{picture}}}
\begin{center}
\bigskip
\bigskip
\bigskip
...
\noindent \textbf{Find:} 
\begin{itemize}
\item nonmonotonic revision \alert{$\cR_{\mi{NM}}$} of \gr{$\cR_H$}, such that 
\only<1>{\smallskip 

its predictive quality is better then of \gr{$\cR_H$}}

\only<3->{\normalsize{\begin{itemize}

\item number of \bl{conflicting predictions} made by \alert{$\cR^{\mi{aux}}_{\mi{NM}}$} is \textbf{minimal} \smallskip

\item average \bl{conviction} $\mi{conv(r,\cG)=\dfrac{1-supp(r,\cG)}{1-conf(r,\cG)}}$ is \textbf{maximal}\\ \footnotesize{\cite{rulemeasures}}
...
\only<1>{\begin{picture}(0.5,0.5)\put(153,45){\includegraphics[width=0.55\textwidth]{big_pic}}\end{picture}}

\only<2>{\vspace{-5.5cm}
\begin{beamerboxesrounded}[upper=uppercolgreen,lower=lowercolgreen,shadow=true]{Ensure quality of exceptions by minimizing conflicts}\bigskip
\bigskip
...
\small{$\alt<2>{\alert{\cR^{\mi{aux}}_{\mi{NM}}}}{\alert{\cR_{\mi{NM}}}}=\left\{
            \renewcommand{\arraystretch}{1.1}
             \begin{array}{@{\,}l@{~~}l@{}}
              ...
              \visible<2->{\mi{r1^{aux}:\,not\_livesIn(X,Z) \leftarrow isMarTo(Y,X),livesIn(Y,Z),res(X)}\\}
              \mi{\gr{r2:\,livesIn(X,Z)\leftarrow bornIn(X,Z),}\alert{\naf\ immigrant(X)}}\\
              \visible<2->{\mi{r2^{aux}:\,not\_livesIn(X,Z)}\leftarrow bornIn(X,Z),immigrant(X)}
...
\textbf{Intuition:} \alert{researcher} might be a strong exception for \gr{$\mi{r1}$}, but application of \gr{$\mi{r2}$}  to \phantom{Intuition: }the KG could weaken it; less conflicts less weak exceptions
}
\bigskip
\end{beamerboxesrounded}
...
\bl{ \textbf{Step 1.}} Mine predictive association rules in the form of first-order \phantom{\textbf{Step 1.\;}}Horn clauses, \cite{amie}\bigskip
 \bigskip
...
% \end{frame}
\begin{frame}\frametitle{Step 2: (Ab)normal Substitutions}
\vspace{-.4cm}
\alt<2>{\begin{picture}(0.5,0.5)\put(55,-195){\includegraphics[width=0.85\textwidth]{kg_advanced_col_2}}\end{picture}}{\begin{picture}(0.5,0.5)\put(40,-195){\includegraphics[width=0.85\textwidth]{kg_advanced_col_1}}
\end{picture}}
\bigskip
\bigskip
\bigskip
...
\centerline{\textcolor{darkgreen}{$r:\;\mi{livesIn(X,Z)}\leftarrow \mi{isMarriedTo(Y,X),livesIn(Y,Z)}$}}
\end{frame}



\begin{frame}\frametitle{Step 3: Exception Candidates}
\begin{picture}(0.5,0.5)\put(55,-195){\includegraphics[width=0.75\textwidth]{kg_advanced_col_3}}
\end{picture}
\bigskip
\bigskip
\bigskip
...
\leftline{\textcolor{darkgreen}{$r:\;\mi{livesIn(X,Z)}\leftarrow \mi{isMarriedTo(Y,X),livesIn(Y,Z)}$}}\FrameText{
\alert{$\begin{array}{@{\,}l@{~\,}}
\mbox{}\small{\mi{\naf\,researcher(X)}}\\
\mbox{}\small{\mi{\naf\,artist(Y)}}\end{array}$}
}
\end{frame}
...
% \alt<6->{\begin{picture}(0.5,0.5)\put(93,-53){\includegraphics[width=0.45\textwidth]{exp_nm_negl}}\end{picture}}{\alt<5->{\begin{picture}(0.5,0.5)\put(93,-53){\includegraphics[width=0.45\textwidth]{exp_nm_gi}}\end{picture}}{\alt<4->{\begin{picture}(0.5,0.5)\put(93,-53){\includegraphics[width=0.45\textwidth]{exp_horn_gi}}\end{picture}}{\alt<3->{\begin{picture}(0.5,0.5)\put(93,-53){\includegraphics[width=0.45\textwidth]{exp_nm_all}}\end{picture}}{\begin{picture}(0.5,0.5)\put(93,-53){\includegraphics[width=0.45\textwidth]{exp_horn_all}}\end{picture}
% }}}}}
\end{frame}
...
$\gr{r_2:  \mi{actedIn(X, Z)}  \leftarrow
 ...
 \end{tabular}            
  }{\begin{picture}(0.5,0.5)\put(-83,-75){\includegraphics[width=0.56\textwidth]{big_pic_exp}}\end{picture}}
...
%  \end{tabular}            
%   }{\alt<2>{\begin{picture}(0.5,0.5)\put(93,-83){\includegraphics[width=0.5\textwidth]{corr_inc_negl}}\end{picture}}{\begin{picture}(0.5,0.5)\put(93,-83){\includegraphics[width=0.5\textwidth]{corr_pred}}\end{picture}}}
% \end{frame}
