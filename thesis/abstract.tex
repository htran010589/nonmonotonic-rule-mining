...
\begin{itemize}
\item We have introduced a framework to revise and improve quality of positive rules.
\item We have proposed a method for finding exception candidates, assessing their quality and ranking them based on chosen measure with a novel concept of partial materialization.
\item We have implemented a system and conducted experiments to test our methodology. The obtained results are promising and they demonstrate the effectiveness of our approach.
